...
admin.site.register(UnitTopicTopicLink, UnitTopicTopicLinkAdmin)
admin.site.register(BookmarkTopic, BookmarkTopicAdmin)
admin.site.register(FileTopic, FileTopicAdmin)
