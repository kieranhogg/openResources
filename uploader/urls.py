...
urlpatterns = patterns('',
    ...
    url(r'syllabus/(?P<syllabus_id>\d+)/(?P<slug>[-\w]+)/resources/$', views.syllabus_resources, name='syllabus_resources'),
    ...
    url(r'bookmark/link/(?P<bookmark_id>\d+)/(?P<slug>[-\w]+)/$', views.link_bookmark, name='link_bookmark'),
    ...
    url(r'file/link/(?P<file_id>\d+)/(?P<slug>[-\w]+)/$', views.link_file, name='link_file'),
