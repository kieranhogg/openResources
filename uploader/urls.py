...
urlpatterns = patterns('',
    ...
    url(r'^add-resource$', views.add_resource, name='add_resource'),
    ...
    url(r'^(?P<subject_slug>[-\w]+)/(?P<exam_slug>[-\w]+)/(?P<slug>[-\w]+)/$', views.syllabus, name='syllabus'),
    url(r'^(?P<subject_slug>[-\w]+)/(?P<exam_slug>[-\w]+)/(?P<slug>[-\w]+)/resources/$', views.syllabus_resources, name='syllabus_resources'),
    url(r'^(?P<subject_slug>[-\w]+)/(?P<exam_slug>[-\w]+)/$', views.syllabuses, name='syllabuses'),
    url(r'^(?P<subject_slug>[-\w]+)/(?P<exam_slug>[-\w]+)/(?P<syllabus_slug>[-\w]+)/(?P<slug>[-\w]+)/$', views.unit, name='unit'),
    url(r'^(?P<subject_slug>[-\w]+)/(?P<exam_slug>[-\w]+)/(?P<syllabus_slug>[-\w]+)/(?P<unit_slug>[-\w]+)/resources/$', views.unit_resources, name='unit_resources'),
    url(r'^(?P<subject_slug>[-\w]+)/(?P<exam_slug>[-\w]+)/(?P<syllabus_slug>[-\w]+)/(?P<unit_slug>[-\w]+)/(?P<slug>[-\w]+)/$', views.unit_topic, name='unit_topic'),
    url(r'^(?P<subject_slug>[-\w]+)/(?P<exam_slug>[-\w]+)/(?P<syllabus_slug>[-\w]+)/(?P<unit_slug>[-\w]+)/(?P<slug>[-\w]+)/notes/$', views.view_notes, name='view_notes'),
    url(r'^(?P<subject_slug>[-\w]+)/(?P<exam_slug>[-\w]+)/(?P<syllabus_slug>[-\w]+)/(?P<unit_slug>[-\w]+)/(?P<slug>[-\w]+)/notes/edit/$', views.notes, name='notes'),
    url(r'^(?P<slug>[-\w]+)/$', views.subject, name='subject'),
