...
urlpatterns = patterns('',
    ...
    url(r'^lesson/(?P<slug>[\w\d-]+)/edit', views.edit_lesson, name='edit_lesson'),
    ...
    url(r'^(?P<subject_slug>[\w\d-]+)/(?P<exam_slug>[\w\d-]+)/(?P<syllabus_slug>[\w\d-]+)/(?P<unit_slug>[\w\d-]+)/$', views.unit_topic, name='unit_topic'),
